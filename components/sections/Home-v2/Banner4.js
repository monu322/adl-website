                            ...
                            <div className="banner__left">
                                <div className="block-text">
                                    {/* <h2 className="heading">World's First<br />
                                        ...
                                        Butler</h2> */}
                                        <h2 className="heading">Streamline Your Restaurant Operations with Our Advanced Service Robots</h2>
                                    <h4 className="heading">Focus on What You Do Best 
                                   </h4>
                                   <p className="desc">Cooking Amazing Food and Delivering Exceptional Customer Service
