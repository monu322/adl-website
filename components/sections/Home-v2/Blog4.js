                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="block-text center">
                                <h6 className="sub-heading"><span>Latest News and Insights</span></h6>
                                <h5 className="heading wow" data-splitting>Stay up-to-date with the latest developments in restaurant technology, industry trends, <br />
                                and how our robots are making a difference in the culinary world.
</h5>
                            </div>
                        </div>
                            ...
                            <div className="blog-box">
                                <div className="image">
                                    <Link href="/blog-details-1">
                                        <img src="/assets/images/blogs/2.jpg" alt="" />
                                    </Link>
                                </div>
                                <div className="content center">
                                    ...
                                    <Link href="/blog-details-1" className="h5 title">The Evolution and Impact of Humanoid Robots in Modern
                      Society</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="blog-box">
                                ...
                                <div className="content center">
                                    ...
                                    <Link href="/blog-details-2" className="h5 title">Humanoid Robots: Pioneering the Future of Human-Robot
                      Collaboration</Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="blog-box">
                                <div className="image">
                                    <Link href="/blog-details-3">
                                        <img src="/assets/images/blogs/3.jpg" alt="" />
                                    </Link>
                                </div>
                                <div className="content center">
                                    <div className="meta ">
                                    ...
                                    <Link href="/blog-details-3" className="h5 title">Humanoid Robots in Entertainment: Transforming the
                      Industry</Link>
                                </div>
                            </div>
                        </div>
