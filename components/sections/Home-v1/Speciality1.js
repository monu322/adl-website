            ...
            <section className="speciality" id="features-section">
                ...
                <div className="container">
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/upper-body.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/parallel-manipulator.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/ai-vision.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/steps.jpg" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/vision-verification.jpg" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="speciality-box" data-aos="fade-up" data-aos-duration={1000}>
                            <div className="icon">
                                ...
                                <img className="img1" src="/assets/images/item/ros-inside.png" alt="" />
                            </div>
