              ...
              <div className="portfolio__left">
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    ...
                    <p>
                      The robot operates independently, making decisions and
                      executing tasks without human intervention. It navigates
                      its environment, identifies objects, and performs actions
                      with precision, enhancing efficiency and adaptability in
                      various scenarios.
                    </p>
                  </div>
                </div>
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    ...
                    <p>
                      {" "}
                      With intricate manipulative abilities, the robot exhibits
                      remarkable dexterity in handling objects of varying
                      shapes, sizes, and textures. Its agile fingers and
                      adaptable grip enable delicate tasks and intricate
                      maneuvers, facilitating versatile functionality in diverse
                      environments.
                    </p>
                  </div>
                </div>
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Endowed with advanced cognitive capabilities, the robot
                      demonstrates high-level intelligence in problem-solving,
                      decision-making, and learning. It assimilates information
                      from its surroundings, adapts to dynamic conditions, and
                ...
                <div className="portfolio-box">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Equipped with the capability to expand its repertoire of
                      capabilities, the robot can download new skills and
                      functionalities as needed. This feature enables seamless
                      integration of additional tasks, upgrades, or specialized
                      functions, enhancing its versatility and utility in
                      evolving contexts.
                    </p>
                  </div>
                </div>
