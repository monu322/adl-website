...
export default function CardSlider5() {
    return (
        <>
            <Swiper {...swiperOptions} className="swiper cardSwiper5">
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-15.png" alt="" />
                        </div>
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-16.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-11.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-18.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-19.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-20.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
                ...
                <SwiperSlide>
                    <div className="card-box s2">
                        <div className="image">
                            <img src="/assets/images/layouts/item-21.png" alt="" />
                        </div>
                        <div className="content">
                            <div className="info d-flex">
                                <img src="/assets/images/layouts/avt-06.png" alt="" />
