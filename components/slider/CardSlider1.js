...
export default function CardSlider1() {
    return (
        <>
            <Swiper {...swiperOptions} className="swiper cardSwiper">
                <div className="swiper-wrapper">
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-01.png" alt="" />
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-02.png" alt="" />
                                </div>
                                <div className="info d-flex">
                    ...
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-03.png" alt="" />
                                </div>
                                <div className="info d-flex">
                    ...
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-04.png" alt="" />
                                </div>
                                <div className="info d-flex">
                                    <img src="/assets/images/layouts/avt-06.png" alt="" />
                                    <div>
                    ...
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-05.png" alt="" />
                                </div>
                                <div className="info d-flex">
                                    <img src="/assets/images/layouts/avt-07.png" alt="" />
                                    <div>
