...
export default function BannerSlider3() {
    return (
        <>
            <Swiper {...swiperOptions} className="swiper bannerSwiper3">
                <div className="swiper-wrapper">
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-09.png" alt="" />
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="card-box">
                            ...
                            <div className="content">
                                <div className="image">
                                    <img src="/assets/images/layouts/item-10.png" alt="" />
                                </div>
                                <div className="info d-flex">
