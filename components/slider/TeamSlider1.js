            ...
            <Swiper {...swiperOptions}>
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Monu John</Link>
                            <p className="postion">
                                Founder &amp; CEO
                            </p>
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Niju Thomas</Link>
                            <p className="postion">
                                Founder & CTO
                            </p>
                            <ul className="list-social">
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Sreejith Nair</Link>
                            <p className="postion">
                                Head of Development
                            </p>
                            <ul className="list-social">
                ...
                <SwiperSlide>
                    <div className="team-box">
                        ...
                        <div className="content">
                            <Link href="/team" className="h5 name">Dithin Dineshan</Link>
                            <p className="postion">
                                Head of Design
                            </p>
                            <ul className="list-social">
