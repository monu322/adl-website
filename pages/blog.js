                                ...
                                <div className="list">
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">5 CELEBRITY-BACKED NFT PROJECTS THAT TURNED OUT TO BE SCAMS</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        <div className="image">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">Andreessen Horowitz Launches 'Can't Be Evil' Licenses to Help Plug NFT Copyright Confusion</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">French Brand Hermès Establishes Groundwork For Web3 Foray, Details Here</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">Meta Lets Limited Users Cross-Post Digital Collectibles Like NFTs Across Instagram and Facebook</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">CoinDCX Launches DeFi Mobile App ‘Okto’ Aimed at Widespread Expansion of Web3 in India</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">MTV Music Awards to See Eminem, Snoop Dogg Perform in Bored Apes Track</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="/blog-details" className="title">Over $100 Million Worth of NFTs Stolen by Hackers Between July 2021-2022: Elliptic</Link>
                                            <p className="text">Below is a list of frequently asked questions and answers from partners and 3D artist. Please check this FAQ first before contacting us.</p>
                                        </div>
                                    </div>
                                    <div className="blog-box-2">
